...
//(IN p_apellido VARCHAR(50), IN p_oficio VARCHAR(50), IN p_dir INT, IN p_salario INT, IN p_comision INT, IN p_nombreDepart VARCHAR(50))
//BEGIN
//    DECLARE v_idDepart INT;
//    DECLARE v_idEmpleado INT;
//    SELECT DEPT_NO INTO v_idDepart FROM DEPT WHERE DNOMBRE = p_nombreDepart;
//    SELECT MAX(EMP_NO) +1 INTO v_idEmpleado FROM EMP;
//    INSERT INTO EMP VALUES (v_idEmpleado, p_apellido, p_oficio, p_dir, NOW(), p_salario, p_comision, v_idDepart);
//END $$
//DELIMITER ;

//CALL SP_INSERT_EMPLEADOS_DINAMICO('PACO MYSQL', 'ANALISTA', 7839, 10, 1, 'VENTAS MYSQL');
#endregion
...
namespace MvcNetCoreEFMultiplesBBDD.Repositories
{
    public class RepositoryEmpleadosMySql: IRepositoryEmpleados
    {
        ...
        {
            string sql = "CALL SP_INSERT_EMPLEADOS_DINAMICO(@p_apellido, @p_oficio, @p_dir, @p_salario, @p_comision, @p_nombreDepart)";
